...
export function FolderTree({
    ...
    return folders
      ...
      .map((folder) => {
        ...
        return (
          <div key={folder.id}>
            <div
              className={`folder-row ${active === folder.id ? "active" : ""}`}
            ...
            >
              ...
              <button
                className="folder-manage icon-button"
  ...
  return (
    <nav aria-label="Drill folders">
      <button
        className={`all-drills ${active === null ? "active" : ""}`}
