...
- Horizontal full court (40 × 20 m), half court with the goal at the top (attacking view) or bottom (defending view), a compact 20 × 16 m half-court option, and configurable rectangular practice areas. Floor/goal-area/line colors, line weights, grid, player labels, and boundary highlights are editable. Courts include goal areas, dashed 9 m lines, 7 m marks, 4 m goalkeeper marks, and substitution marks.
